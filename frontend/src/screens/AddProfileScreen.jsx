        ...
        <VStack flex={1} justifyContent="space-between" mx={24} mt={16} mb={24}>
          ...
          <VStack flex={1}>
            <VStack mb={24} my={page !== 4 ? "$24" : "$8"}>
              ...
              {page === 5 ? (
                <Text style={styles.hearinAidText}>
                  Do they already have any hearing Aid.
                </Text>
              ) : (
                <></>
              )}
                    ...
                    <SelectContent h="50%">
                      ...
                      <SelectVirtualizedList
                        ...
                        renderItem={(year) => {
                          return (
                            <SelectItem
                              label={year.item.toString()}
                              value={year.item.toString()}
                            />
                          );
                        }}
            ...
            {page === 4 && <CameraProfile dispatch={dispatch} image={image} />}
            {page === 5 && (
            ...
            {page === 6 && (
              <VStack alignItems="center" space="xl">
                ...
                <Text style={{ ...Typography.heading.h5, textAlign: "center" }}>
                  Congrats successfully added new kid!!!
                </Text>
              </VStack>
            )}
          </VStack>
