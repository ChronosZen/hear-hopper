        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container} >
                <HStack alignItems="center" space="md">
                    ...
                    <HeaderText text="Parental Control" underlineColor={Colors.secondary.g5} />
                </HStack>
                ...
                <VStack>
                    ...
                    <Divider bg="$trueGray300" $dark-bg="$backgroundDark700" marginVertical={Spacing.l} />
                    <Box>
                        {/* <Pressable onPress={() => {
                            navigation.navigate("Parental Control Noise Check")
                        }}> */}
                        <HStack justifyContent="space-between" alignItems="center">
                            <VStack space="sm">
                                <Heading style={styles.heading}>Max Value</Heading>
                                <Text style={styles.text}>
